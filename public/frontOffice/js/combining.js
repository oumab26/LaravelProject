...
(function () {
    ...
    var u = e.jQuery, a = e.console, h = "undefined" != typeof a, d = Object.prototype.toString;
    ...
    function o(t) {
        function e(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var y = r.paddingLeft + r.paddingRight, g = r.paddingTop + r.paddingBottom,
                    v = r.marginLeft + r.marginRight, b = r.marginTop + r.marginBottom,
                    _ = r.borderLeftWidth + r.borderRightWidth, E = r.borderTopWidth + r.borderBottomWidth, L = u && h,
                    x = i(e.width);
    ...
    function e(t, e) {
        ...
        return n.prototype._resetLayout = function () {
            ...
            if (this.getContainerWidth(), !this.columnWidth) {
                for (var t, i = 0, n = this.items.length; n > i; i++) if (!this.items[i].isIgnored) {
                    t = this.items[i];
                    break
                }
                t || (t = this.items[0]);
...
!function (n) {
    ...
    n.fn.masonryFilter = function (e) {
        var i = function (n) {
            ...
            var r = t.masonry("getAllItems"), o = [], s = [];
            n.each(r, function (i) {
                var t = r[i], a = n(t.element), u = e.filter && e.filter.call(a);
...
var JobBoard = function () {
    ...
    var e = $(window).width(), t = function () {
        ...
        if (jQuery(".dzload").each(function () {
            ...
            if (0 == $(".mo-left .header-nav").children("div").length) {
                ...
                jQuery(".mo-left .header-nav").prepend(t), jQuery(".mo-left .header-nav .logo-header > a > img").attr("src", "frontOffice/images/logo.png"), jQuery(".mo-left.lw .header-nav .logo-header > a > img").attr("src", "frontOffice/images/logo-white.png")
            }
        ...
        $(".header-nav li").unbind().each(function (e) {
            if ($("ul", this).length) {
                var t = $("ul:first", this), i = t.offset().left, r = t.width();
                $("body").height();
    ...
    return monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], u.setMonth(u.getMonth() + 1), u = u.getDate() + " " + monthNames[u.getMonth()] + " " + u.getFullYear(), {
        init: function () {
            jQuery(".box-hover").on("mouseenter", function () {
                ...
                }), jQuery(".scroll-bar").length > 0 && $(".scroll-bar").unbind().on("click", function (e) {
                    if (e.preventDefault(), "" !== this.hash) {
                        var t = this.hash, i = $(t).offset().top, r = parseInt($(".onepage").css("height"), 10);
                        $("body").scrollspy({target: ".navbar", offset: r + 2});
                        var n = i - r + 500;
                ...
                jQuery(window).on("scroll", function () {
                    if (jQuery(".sticky-header").length > 0) {
                        ...
                        $(window).scrollTop() > e.offset().top ? (e.addClass("is-fixed"), $(".header-style-5 .container > .logo-header .logo").attr("src", "frontOffice/images/logo.png")) : (e.removeClass("is-fixed"), $(".header-style-5 .container > .logo-header .logo").attr("src", "error-404.html"))
                    }
                })
            ...
            }(u), $(".content-scroll").length > 0 && $(".content-scroll").mCustomScrollbar({
                setWidth: !1,
                setHeight: !1,
                axis: "y"
                ...
                jQuery(".modal").on("show.bs.modal", l), $('[data-toggle="tooltip"]').tooltip()
        }, load: function () {
            ...
            e = $(window).width(), i(), t(), o(), s(), a()
        }
    }
}();
jQuery(document).ready(function () {
    JobBoard.init(), jQuery(".navicon").on("click", function () {
    ...
    JobBoard.load(), setTimeout(function () {
...
jQuery(document).ready(function () {
    ...
    jQuery(".img-carousel").owlCarousel({
        ...
        responsive: {0: {items: 1}, 480: {items: 2}, 1024: {items: 3}, 1200: {items: 5}}
    })
});
...
function contactForm() {
    ...
    window.verifyRecaptchaCallback = function (e) {
        ...
        var s = $(this).attr("action"), a = $(this).serialize();
        $.ajax({
            method: "POST", url: s, data: a, dataType: "json", success: function (t) {
    ...
    }, 1e4), $(".dzSubscribe").on("submit", function (t) {
        t.preventDefault();
        var s = $(this).attr("action"), a = $(this).serialize();
        $.ajax({
            method: "POST", url: s, data: a, dataType: "json", success: function (t) {
...
function init_map() {
    ...
    }), infowindow = new google.maps.InfoWindow({content: "<strong>Title</strong><br>London, United Kingdom<br>"}), google.maps.event.addListener(marker, "click", function () {
